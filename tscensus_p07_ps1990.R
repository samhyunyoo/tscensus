...
tscensus1990 <- readRDS("data/tscensus1990.rds")
ts1990 <- tscensus1990 |> 
  mutate(
    ...
    org_check = as.numeric(V9), 
    org_code0 = as.numeric(V10), 
    ...
    # ceb_boy = as.numeric(V43), 
    # ceb_girl = as.numeric(V42), 
...
ggplot(pop1990, aes(x = agegr, y = pop_signed, fill = res_admin)) +
  geom_col(width = 0.9) +
  coord_flip() +
...
ggsave("graphs/prd1990_res_admin.png", width = 10, height = 5)
