...
tscensus2010 <- readRDS("data/tscensus2010.rds")
ts2010 <- tscensus2010 |> 
  mutate(
    ...
    ceb_boy = ifelse(V72 == "99", NA, as.numeric(V72)), 
    ceb_girl = ifelse(V74 == "99", NA, as.numeric(V74)), 
...
ggplot(pop2010, aes(x = agegr, y = pop_signed, fill = res_admin)) +
  geom_col(width = 0.9) +
  coord_flip() +
...
ggsave("graphs/prd2010_res_admin.png", width = 10, height = 5)
