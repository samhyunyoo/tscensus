...
tscensus1995 <- readRDS("data/tscensus1995.rds")
ts1995 <- tscensus1995 |> 
  mutate(
    ...
    org_check = as.numeric(V11), 
    org_code0 = as.numeric(V12), 
...
ggplot(pop1995, aes(x = agegr, y = pop_signed, fill = res_admin)) +
  geom_col(width = 0.9) +
  coord_flip() +
...
ggsave("graphs/prd1995_res_admin.png", width = 10, height = 5)
